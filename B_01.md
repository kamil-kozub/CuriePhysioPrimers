...
# Kontrola przysadki przez podwzgórze – rola naczyń wrotnych

## 1. **Podwzgórze – nadrzędny ośrodek regulacji hormonalnej**

- **Lokalizacja:** Podwzgórze znajduje się w dolnej części mózgu, nad przysadką mózgową.
- **Rola:** Koordynuje odpowiedź hormonalną organizmu, regulując wydzielanie hormonów przysadki.

---

## 2. **Naczynia wrotne przysadki**

- **System wrotny:** Specjalny układ naczyń krwionośnych łączących podwzgórze z przednim płatem przysadki.
- **Funkcja:** Służy do transportu hormonów uwalniających (releasing hormones) i hamujących (inhibiting hormones) bezpośrednio z podwzgórza do adenohypofizy.

---

## 3. **Hormony regulujące przedni płat przysadki**

|**Hormon podwzgórza**|**Skrót**|**Wpływ na przysadkę**|
|---|---|---|
|Hormon uwalniający tyreotropinę|TRH|Stymuluje wydzielanie TSH (tyreotropiny)|
|Hormon uwalniający kortykotropinę|CRH|Stymuluje wydzielanie ACTH|
|Gonadoliberyna|GnRH|Stymuluje wydzielanie FSH i LH|
|Hormon uwalniający hormon wzrostu|GHRH|Stymuluje wydzielanie GH|
|Somatostatyna|-|Hamuje wydzielanie GH|
|Dopamina|-|Hamuje wydzielanie prolaktyny|

---

## 4. **Przepływ hormonów w systemie wrotnym**

- Hormony podwzgórza są wydzielane do naczyń wrotnych.
- Dzięki temu szybko docierają do przedniego płata przysadki, gdzie regulują wydzielanie hormonów tropowych.

---

## 5. **Znaczenie fizjologiczne naczyń wrotnych**

- **Efektywność:** Bezpośredni transport hormonów pozwala na precyzyjną regulację przysadki.
- **Szybkość:** Skraca czas działania hormonów uwalniających i hamujących.
- **Ograniczenie dystrybucji:** Hormony podwzgórza działają lokalnie, co zapobiega ich rozprzestrzenianiu się po całym organizmie.